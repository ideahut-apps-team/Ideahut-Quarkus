...
## Request Filter
- _@Context_ ResourceInfo wajib ada karena akan digunakan untuk mengecek request dan dikaitkan dengan [RequestInfo Collector](./02-advice.md#requestinfo-collector)
- _@Context_ RoutingContext wajib ada karena akan digunakan untuk response.
