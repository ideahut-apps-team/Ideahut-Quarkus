...
.setXlang(null);
```
* `setFory`: Jika ingin menggunakan object Fory yang sudah ada, atau custom. Bisa berguna untuk integrasi dengan [GraalVM](https://fory.apache.org/docs/object-serialization/java/graalvm).
