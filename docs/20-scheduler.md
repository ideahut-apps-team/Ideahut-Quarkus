...
SchedulerHandler schedulerHandler(
   ...
   // Karena RMI registry di native image akan menyebabkan error saat runtime.
   Properties properties = new Properties();
   properties.setProperty(StdSchedulerFactory.PROP_SCHED_RMI_EXPORT, "false");
   properties.setProperty(StdSchedulerFactory.PROP_SCHED_RMI_CREATE_REGISTRY, "false");
